...
const STATUS_VARIANT_MAP: Record<string, 'default' | 'success' | 'warning' | 'danger' | 'info'> = {
  active: 'success',
  pending: 'warning',
  approved: 'success',
  reported: 'info',
...
export default function StatusBadge({
  ...
  return (
    <span
      className={`inline-block rounded-full font-medium whitespace-nowrap ${sizeClass} ${VARIANT_MAP[actualVariant]}`}
    >
